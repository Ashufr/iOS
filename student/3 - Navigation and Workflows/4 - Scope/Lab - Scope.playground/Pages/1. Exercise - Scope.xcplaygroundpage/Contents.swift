...
//print("The value of foo is \(foo)")
print("Because the scope of foo is wihtin the loop only")
...
print("Because x is defined globally and wihtin the loop aswell but foo is defined only within the loop")
...
greeting(greeting: nil, name: "Ashu")
greeting(greeting: "Sat Sri Akal", name: "Ashu")
